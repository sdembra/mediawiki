...
resource "aws_route_table_association" "mw_rta_private_c" {
  route_table_id = "${aws_route_table.mw_rt_private.id}"
  subnet_id = "${aws_subnet.mw_sub_private_c.id}"
}
